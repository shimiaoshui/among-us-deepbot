...
[![Release](https://img.shields.io/badge/release-0.10.4--rc1-00c2ff)](https://github.com/shimiaoshui/among-us-deepbot/releases)
...
Current test release: `0.10.4-client-visibility-rc1`. It ships separate one-click host and client installers for one fingerprinted TOR 4.6.0 compatibility build.
